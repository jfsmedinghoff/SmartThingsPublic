...
*
*  Copyright 2016 John Smedinghoff
...
definition(
    ...
    namespace: "jfsmedinghoff",
    author: "John Smedinghoff",
...
preferences {
    page(name: "mainPage", title: "Install Video Camera", install: true, uninstall:true) {
        ...
        section("Add a Camera") {
            ...
            ["http://192.168.0.46/av.asf?user=admin&pwd=Dec14ember_":"Driveway Camera"] //shenzhen(Patriot Lighting)
...
def initialize() {
    ...
    try {
        ...
        def childDevice = addChildDevice("jfsmedinghoff", "Generic Video Camera", DNI, null, [name: app.label, label: app.label, completedSetup: true])
    } catch (e) {
